...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'object_oc_key' => ['type' => 'index', 'columns' => ['object_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'comments_ibfk_1' => ['type' => 'foreign', 'columns' => ['object_id'], 'references' => ['objects', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2017-03-10 20:22:53',
            'modified' => '2017-03-10 20:22:53'
        ],
    ];
}
