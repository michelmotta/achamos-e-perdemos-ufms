      ...
      <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-user fa-lg"></i></a>
        <ul class="dropdown-menu settings-menu">
          <li>
            ...
            <?= $this->Html->link(__('<i class="fa fa-user fa-lg"></i> Perfil') ,['controller' => 'Users', 'action' => 'view', $userId], ['escape' => false]) ?>
          </li>
          <li>
            <?= $this->Html->link(__('<i class="fa fa-sign-out fa-lg"></i> Sair') ,['controller' => 'Users', 'action' => 'logout'], ['escape' => false]) ?>
          </li>
        </ul>
      </li>
    </ul>
