            ...
            <fieldset>
                ...
                if (!empty($object->uploads)): 
                    ...
                    foreach ($object->uploads as $uploads) {
                        ...
                        echo '<div class="col-md-3 object-upload">';
                            echo  $this->Html->image('uploads/'. $uploads->file, ['alt' => '']) . '</br>';
                            echo  $this->Form->postLink(__('Deletar'), ['controller' => 'Uploads', 'action' => 'deleteUpload', $uploads->id], ['block' => true, 'confirm' => __('Are you sure you want to delete # {0}?', $uploads->id)]);
                        echo '</div>';
                        $post_counter++;
                    } 
                    echo '</div>';
